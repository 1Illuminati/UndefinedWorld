...
public enum AttributeType {
    ...
    PHYSICS_DAMAGE_MULTIPLY_REDUCE("물리데미지 증폭 감소"),
    ...
    MAGIC_DAMAGE_MULTIPLY_REDUCE("마법데미지 증폭 감소"),
    ...
    CRITICAL_DAMAGE_REDUCE("치명타 데미지 감소"),
    CRITICAL_DAMAGE_DEFENSE("치명타 데미지 방어력"),
    CRITICAL_DAMAGE_RESISTANCE("치명타 데미지 저항력"),
    CRITICAL_DAMAGE_MUTIPLY_REDUCE("치명타 데미지 증폭"),
    CRITICAL_DAMAGE_DEFENSE_REDUCE("치명타 데미지 방어력"),
    CRITICAL_DAMAGE_RESISTANCE_REDUCE("치명타 데미지 저항력"),
