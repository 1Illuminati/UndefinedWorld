...
public class PhysicalResolver extends CriticalResolver {
    ...
    public double resolveDefDamage(double originDamage) {
        ...
        double def = manager.getAttributeValue(AttributeType.PHYSICS_DAMAGE_DEFENSE);
        double defReduce = manager.getAttributeValue(AttributeType.PHYSICS_DAMAGE_DEFENSE_REDUCE);
        double res = manager.getAttributeValue(AttributeType.PHYSICS_DAMAGE_RESISTANCE);
    ...
    public double resolveAtkDamage(double originDamage) {
        ...
        double atk = manager.getAttributeValue(AttributeType.PHYSICS_DAMAGE);
        double atkReduce = manager.getAttributeValue(AttributeType.PHYSICS_DAMAGE_REDUCE);
        double mul = manager.getAttributeValue(AttributeType.PHYSICS_DAMAGE_MULTIPLY);
