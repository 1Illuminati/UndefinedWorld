...
public class MagicAtkModifier implements DamageModifier{
    @Override
    public void apply(DamageCTX ctx, DamageModifierBus bus) {
        ...
        double atk = manager.getAttributeValue(AttributeType.MAGIC_DAMAGE) + manager.getAttributeValue(AttributeType.ALL_DAMAGE);
        double atkReduce = manager.getAttributeValue(AttributeType.MAGIC_DAMAGE_REDUCE);
        double mul = manager.getAttributeValue(AttributeType.MAGIC_DAMAGE_MULTIPLY) + manager.getAttributeValue(AttributeType.ALL_DAMAGE_MULTIPLY);
